...
<body>
    ...
    <div class="container">
        <div class="brand-section">
            <div class="row">
                <div class="col-6">
                    <h1 class="text-white">my shop</h1>
                </div>
                <div class="col-6">
                    <div class="company-details">
                        <p class="text-white">bhadrapur</p>
                        <p class="text-white">+91 9874563214</p>
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?php echo URLROOT?>/js/ajax.js?v=<?php echo uniqid()?>"></script>
