		...
		<div class="container-fluid">
			<div class="offcanvas offcanvas-start sidebar-nav bg-light" tabindex="-1" id="sidebar">
				<div class="offcanvas-body p-0">
					<a class="navbar-brand me-auto ms-lg-0 ms-3 text-uppercase fw-bold nav-sidebar-brand text-dark " href="#">TPS for shop</a>
					<nav class="navbar-dark">
						<ul class="navbar-nav nav nav-pills mx-3 px-2 my-3 list-group " id="selectable">

							<a href="<?php echo URLROOT ?>pages/dashboard" class=" nav-link text-dark list-group-item-action list-group-item-light " id="v-pills-home-tab"><i class="fa-solid fa-gauge-high pr-2 mr-3"></i> Dashboard</a>
